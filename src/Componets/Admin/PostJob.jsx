...
console.log(err))
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2" onSubmit={sendData}>
      ...
      <div class="sm:col-span-2">
        <label for="aboutJob" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">aboutJob*</label>
      ...
      <div class="sm:col-span-2">
        <label for="Experience" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Experience*</label>
        <input name="Experience" value={experience} onChange={(e)=>setExperience(e.target.value)} class=" w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring"></input>
      </div>
      <div class="sm:col-span-2">
