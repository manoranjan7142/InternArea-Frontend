...
function DeatilOfApplication() {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await axios.get(`https://internareabackend.onrender.com/api/application/${id}`);
    ...
    const handleAcceptReject = async (id, action) => {
      try {
        const response = await axios.put(`https://internareabackend.onrender.com/api/application/${id}`, { action });
